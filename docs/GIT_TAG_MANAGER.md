# Git Tag Manager - Tài Liệu Hướng Dẫn
...
2. [Cài Đặt](#-cài-đặt)
3. [Cấu Hình](#️-cấu-hình)
4. [Hướng Dẫn Sử Dụng](#-hướng-dẫn-sử-dụng)
5. [Đóng Gói Ứng Dụng](#-đóng-gói-ứng-dụng)
...
### Build standalone app (macOS/Windows)

```bash
# Cài pyinstaller
pip install pyinstaller

# Build với hỗ trợ drag & drop
...
- **macOS**: `dist/GitTagManager.app`
- **Windows**: `dist/GitTagManager.exe`
...
App sẽ tự tạo file config rỗng khi khởi chạy lần đầu. Bạn cũng có thể tạo thủ công:
